...
public class CreditFacilityTemplateDTO implements Serializable {
    ...
    public CreditFacilityTemplateDTO(CreditFacilityTemplate creditFacilityTemplate, List<Formula> formulaList) {
        ...
        this.showInLead = creditFacilityTemplate.getShowInLead();
        ...
        for(CftCustomFacilityInfo cftCustomFacilityInfo: creditFacilityTemplate.getOrderedCftCustomFacilityInfos()){
    ...
    public void setCftCustomFacilityInfoDTOList(List<CftCustomFacilityInfoDTO> cftCustomFacilityInfoDTOList) {
        this.cftCustomFacilityInfoDTOList = cftCustomFacilityInfoDTOList;
    }
    ...
    public String toString() {
        return "CreditFacilityTemplateDTO{" +
                ...
                ", cftCustomFacilityInfoDTOList=" + cftCustomFacilityInfoDTOList +
                ", newFacilityEmail=" + newFacilityEmail +
                ", existingFacilityEmail=" + existingFacilityEmail +
                '}';
    }

    public AppsConstants.YesNo getShowInLead() {
        if (this.showInLead == null){
