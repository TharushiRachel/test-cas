...
public class LeadFacilityDetailDTO implements Serializable {
    ...
    public LeadFacilityDetailDTO() {
    }

    public LeadFacilityDetailDTO(LeadFacilityDetail leadFacilityDetail) {
        ...
        this.amount = leadFacilityDetail.getAmount();
