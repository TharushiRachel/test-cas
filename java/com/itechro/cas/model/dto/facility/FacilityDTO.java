...
public class FacilityDTO implements Serializable {
    ...
    private String purposeRefDescription;
    ...
    private List<FacilityCustomInfoDataDTO> facilityCustomInfoDataDTOList;
    ...
    private List<UPCTemplateCommentHistoryDTO> fusTraceList = new ArrayList<>();
    ...
    public FacilityDTO(Facility facility, FacilityLoadOptionDTO loadOptionDTO) {
        this(facility, null, null);
    }

    public FacilityDTO(Facility facility, FacilityLoadOptionDTO loadOptionDTO, List<Formula> formulaList) {
        ...
        if (facility.getCreditFacilityTemplate() != null) {
            ...
            this.creditFacilityTemplateDTO = new CreditFacilityTemplateDTO(facility.getCreditFacilityTemplate());
        ...
        this.isAdditional = facility.getIsAdditional();
        this.isAnnual = facility.getIsAnnual();
        this.isTermsAmended = facility.getIsTermsAmended();
        this.isReStructure = facility.getIsReStructure();
        this.isReSchedule = facility.getIsReSchedule();
        this.exchangeRate = facility.getExchangeRate();
        this.loanLimitId = facility.getLoanLimitId();
        this.fusTraceList = facility.getFusTraceList();
        this.isReStructure = facility.getIsReStructure();
        this.isReSchedule = facility.getIsReSchedule();
        ...
        if (loadOptionDTO != null) {
            ...
            if (loadOptionDTO.isLoadFacilityInterestRate()) {
                ...
                if (facility.getCreditFacilityTemplate() != null && facility.getCreditFacilityTemplate().getCftInterestRates() != null) {
            ...
            if (loadOptionDTO.isLoadFacilityVitalInfo()) {
                ...
                if (facility.getCreditFacilityTemplate() != null && facility.getCreditFacilityTemplate().getCftVitalInfos() != null) {
            ...
            if(loadOptionDTO.isLoadFacilityCustomInfo()){ ///
                List<Integer> cftCustomInfoIDs = new ArrayList<>();
                for(FacilityCustomInfoData facilityCustomInfoData : facility.getFacilityCustomInfoData()){
                    FacilityCustomInfoDataDTO facilityCustomInfoDataDTO = new FacilityCustomInfoDataDTO();
                    if(facilityCustomInfoData.getCftCustomFacilityInfoID() != null){
                        cftCustomInfoIDs.add(facilityCustomInfoData.getCftCustomFacilityInfoID());
                    }
                    if(facilityCustomInfoData.getStatus() == AppsConstants.Status.ACT){
                        facilityCustomInfoDataDTO.setFacilityCustomInfoDataID(facilityCustomInfoData.getFacilityCustomInfoDataID());
                        facilityCustomInfoDataDTO.setFacilityID(facilityCustomInfoData.getFacility().getFacilityID());
                        facilityCustomInfoDataDTO.setCftCustomFacilityInfoID(facilityCustomInfoData.getCftCustomFacilityInfoID());
                        facilityCustomInfoDataDTO.setCustomFacilityInfoName(facilityCustomInfoData.getCustomFacilityInfoName());
                        facilityCustomInfoDataDTO.setCustomFacilityInfoCode(facilityCustomInfoData.getCustomFacilityInfoCode());
                        facilityCustomInfoDataDTO.setCustomInfoData(facilityCustomInfoData.getCustomInfoData());
                        facilityCustomInfoDataDTO.setMandatory(facilityCustomInfoData.getMandatory());
                        facilityCustomInfoDataDTO.setDisplayOrder(facilityCustomInfoData.getDisplayOrder());
                        facilityCustomInfoDataDTO.setStatus(facilityCustomInfoData.getStatus());


                        this.getFacilityCustomInfoDataDTOList().add(facilityCustomInfoDataDTO);
                    }
                }

                if (facility.getCreditFacilityTemplate() != null && facility.getCreditFacilityTemplate().getCftCustomFacilityInfos() != null) {
                    for (CftCustomFacilityInfo cftCustomFacilityInfo : facility.getCreditFacilityTemplate().getCftCustomFacilityInfos()) {
                        if (cftCustomFacilityInfo.getStatus() == AppsConstants.Status.ACT
                                && !cftCustomInfoIDs.contains(cftCustomFacilityInfo.getCftCustomFacilityInfoID())) {
                            this.getFacilityCustomInfoDataDTOList().add(new FacilityCustomInfoDataDTO(cftCustomFacilityInfo, facilityID));
                        }
                    }
                    this.getFacilityCustomInfoDataDTOList();
                }
            }
            ...
            if (loadOptionDTO.isLoadOtherFacilityInfo()) {
                if (formulaList == null) {
                    ...
                    if (facility.getCreditFacilityTemplate() != null && facility.getCreditFacilityTemplate().getOrderedCftOtherFacilityInformations() != null) {
    ...
    public List<FacilityCustomInfoDataDTO> getFacilityCustomInfoDataDTOList() {
        if(facilityCustomInfoDataDTOList == null){
            facilityCustomInfoDataDTOList = new ArrayList<>();
        }
        return facilityCustomInfoDataDTOList;
    }

    public void setFacilityCustomInfoDataDTOList(List<FacilityCustomInfoDataDTO> facilityCustomInfoDataDTOList) {
        this.facilityCustomInfoDataDTOList = facilityCustomInfoDataDTOList;
    }
    ...
    public String toString() {
        return "FacilityDTO{" +
                ...
                ", facilityCustomInfoDataDTOList=" + facilityCustomInfoDataDTOList +
                '}';
    }
    ...
    public String getPurposeRefDescription() {
        return purposeRefDescription;
    }

    public void setPurposeRefDescription(String purposeRefDescription) {
        this.purposeRefDescription = purposeRefDescription;
    }
    ...
    public void setLoanLimitId(String loanLimitId) {
