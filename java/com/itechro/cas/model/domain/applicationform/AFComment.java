...
@Entity
@Table(name = "T_AF_COMMENT")
public class AFComment extends UserTrackableEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_T_AF_COMMENT")
    @SequenceGenerator(name = "SEQ_T_AF_COMMENT", sequenceName = "SEQ_T_AF_COMMENT", allocationSize = 1)
    @Column(name = "AF_COMMENT_ID")
