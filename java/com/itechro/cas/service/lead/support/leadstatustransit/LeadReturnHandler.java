...
public class LeadReturnHandler extends LeadStatusHandler {

    public LeadReturnHandler(Lead lead, LeadStatusUpdateRQ leadStatusUpdateRQ, CredentialsDTO credentialsDTO, CasProperties casProperties) {
    ...
    public void updateLead() throws AppsException {
        ...
        lead.setAssignUserDisplayName(leadStatusUpdateRQ.getAssignUserDisplayName());
    }
}
