...
public class LeadSubmittedHandler extends LeadStatusHandler {

    public LeadSubmittedHandler(Lead lead, LeadStatusUpdateRQ leadStatusUpdateRQ, CredentialsDTO credentialsDTO, CasProperties casProperties) {
        super(lead, leadStatusUpdateRQ, credentialsDTO, casProperties);
    }

    @Override
    public boolean isValidStatusTransition() {
        return lead.getLeadStatus() == DomainConstants.LeadStatus.PENDING || lead.getLeadStatus() == DomainConstants.LeadStatus.RETURNED;
    }
